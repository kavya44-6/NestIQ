...
const O = ({ children }) => <ProtectedRoute allowedRoles={['OWNER']}>{children}</ProtectedRoute>
...
export default function AppRoutes() {
  return (
    <Routes>
      ...
      {/* Admin */}
      <Route path="/admin" element={<A><Navigate to="/admin/dashboard" replace /></A>} />
      <Route path="/admin/dashboard" element={<A><AdminDashboard /></A>} />
      <Route path="/admin/users" element={<A><AdminDashboard /></A>} />
      <Route path="/admin/properties" element={<A><AdminDashboard /></A>} />
      ...
      <Route path="/agent/profile"        element={<G><AgentProfile /></G>} />
      ...
      {/* Owner */}
      <Route path="/owner/login"    element={<GuestRoute role="OWNER"><OwnerLogin /></GuestRoute>} />
      <Route path="/owner/register" element={<GuestRoute role="OWNER"><OwnerRegister /></GuestRoute>} />
      <Route path="/owner/dashboard"    element={<O><OwnerDashboard /></O>} />
      <Route path="/owner/properties"   element={<O><OwnerProperties /></O>} />
      <Route path="/owner/add-property" element={<O><OwnerAddProperty /></O>} />
      <Route path="/owner/inquiries"    element={<O><OwnerInquiries /></O>} />
      <Route path="/owner/messages"     element={<O><OwnerMessages /></O>} />
      <Route path="/owner/profile"      element={<O><OwnerProfile /></O>} />
